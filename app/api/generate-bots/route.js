        ...
        input: [
            {
                ...
                content: [
                    {
                        type: "input_text",
                        text: "You are a bunch of different people scrolling the internet and leaving captions on a meme. Look at this image and write 15 captions that real humans would actually post. Mix up the styles like real people would. Some should be short and dumb (like 3 to 8 words). Some should be crude or unhinged. Some can be longer but still sound like a real person typed it on their phone. Swearing is fine. Typos and lowercase are fine. Do NOT sound like a writer or comedian crafting a joke. No flowery language, no metaphors, no poetic structure. Think more like Xbox Live trash talk, Reddit shitposts, and group chat energy. Bad examples (too AI): \"If arrogance had a sound it would be the quiet sighs of the fans\", \"The inning ends and his ego calls for a time out in tears\". Good examples (actually human): \"I just teabagged your sister\", \"bro looks cooked\", \"this is the worst thing ive ever seen lmao\". IMPORTANT: Do NOT use any colons (:), semi-colons (;), or hyphens (-) in your captions. Return ONLY a valid JSON array of exactly 15 strings. Do not include markdown formatting like ```json."
                    },
                    {
                        type: "input_image",
